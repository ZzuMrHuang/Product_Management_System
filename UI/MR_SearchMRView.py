...
class SelectMRWidget(MySearchWidget):
    ...
    def __init__(self):
        ...
        self.select_conditions = ["MrID","MwID", "MrName"]
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox.setItemText(0, _translate("Form", "按维保ID查询"))
        self.comboBox.setItemText(1, _translate("Form", "按维保名字查询"))
        self.comboBox.setItemText(2, _translate("Form", "按维保负责人查询"))
