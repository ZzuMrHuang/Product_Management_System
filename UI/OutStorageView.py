...
from UI.AddOutStorage import Ui_Dialog
...
class OutStorageWidget(MySearchWidget):
    def __init__(self):
        super().__init__()
        self.select_conditions = ["ProductNO", "OutNO"]
    ...
    def retranslateUi(self, OutStorageForm):
        ...
        self.comboBox.setItemText(1, _translate("OutStorageForm", "按入库编号号查询"))
        self.label_2.setText(_translate("OutStorageForm", "跳转至第"))
        self.jumpEdit.setText(_translate("OutStorageForm", "1"))
        self.totalPageLabel.setText(_translate("OutStorageForm", "页"))
        ...
        self.tableView.setModel(self.queryModel)
        # 按钮绑定事件
        self.addOutStorageButton.clicked.connect(lambda: self.addButtonEvent(Ui_Dialog()))
        # 增加
