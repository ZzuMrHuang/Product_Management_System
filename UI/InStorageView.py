...
class InStorageWidget(MySearchWidget):
    def __init__(self):
        super().__init__()
        self.select_conditions = ["ProductNO", "InNO"]
    ...
    def retranslateUi(self, InStorageForm):
        ...
        self.comboBox.setItemText(0, _translate("InStorageForm", "按产品号查询"))
        self.comboBox.setItemText(1, _translate("InStorageForm", "按入库号查询"))
        self.label_2.setText(_translate("InStorageForm", "跳转至第"))
        self.jumpEdit.setText(_translate("InStorageForm", "1"))
        self.totalPageLabel.setText(_translate("InStorageForm", "页"))
